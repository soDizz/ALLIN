...
export const VestaBlock = ({
  ...
  useGSAP(
    () => {
      ...
      subject.subscribe(char => {
        ...
        const currentIndex = charset.indexOf(
          charset[Math.round(tl.totalTime())],
        );
  ...
  return (
    <div
      ref={container}
      className={`${styles.blockContainer} ${className} custom-vestaBlock-container`}
      data-theme={'magic'}
      data-shape={'circle'}
    >
      {/* foward top */}
