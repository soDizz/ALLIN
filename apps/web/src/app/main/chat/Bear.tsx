...
type BearProps = {
  bearControllerRef: React.RefObject<GSAPTimeline | null>;
};

export const Bear = ({ bearControllerRef }: BearProps) => {
  ...
  useImperativeHandle(bearControllerRef, () => tl.current!);

  return (
    <svg
      ref={bearRef}
      className='h-[70%] absolute left-3 top-1 z-[-1]'
